...
test('dashboard mobile menu opens visibly and navigates from a real browser', async ({ page }) => {
  await page.goto('/');
  ...
  await expect(page.locator('button[aria-controls="dashboard-mobile-menu"]')).toHaveAttribute(
    'aria-expanded',
    'true',
  );
