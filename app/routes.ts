...
export default [
  ...
  route('api/days/:dayId/attendees', 'routes/dashboard/days.$dayId.attendees.tsx'),
  ...
  layout('routes/_dashboard.tsx', [
    ...
    route('dashboard/series/:seriesKey', 'routes/dashboard/series.$seriesKey.tsx'),
    ...
    route('dashboard/admin/day-merges', 'routes/dashboard/admin.day-merges.tsx'),
    ...
    route('dashboard/admin/data-quality', 'routes/dashboard/admin.data-quality.tsx'),
    route('dashboard/admin/operations', 'routes/dashboard/admin.operations.tsx'),
    route('dashboard/admin/members', 'routes/dashboard/admin.members.tsx'),
    route('dashboard/admin/members/:memberId', 'routes/dashboard/admin.members.$memberId.tsx'),
